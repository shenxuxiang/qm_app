...
sealed class MainTabBar(
    val route: String,
    val icon: QmIcons,
    val selectedIcon: QmIcons,
    @StringRes val resourceId: Int,
) {
    object Home : MainTabBar(
        route = "home",
    ...
    object AgriculturalTechnology : MainTabBar(
